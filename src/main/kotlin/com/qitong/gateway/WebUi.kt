...
<div class="card">
  <div class="logo">
    <div class="icon">⚡</div>
    <h1>綦桐AI网关</h1>
    <p>Docker Server v3.18.22-22 · 后台管理</p>
  </div>
  ...
  <div class="tip">⚡ Kotlin→Docker 转换版 · v3.18.22-22 Server</div>
</div>
<script>
...
<div id="app">
  ...
  <header class="topbar">
    ...
    <div class="topbar-title">⚡ 綦桐AI网关 <span class="ver">v3.18.22-22</span></div>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav>
      ...
      <a data-page="users" class="admin-only"><span>👥</span><b>用户管理</b></a>
      <a data-page="about"><span>ℹ️</span><b>关于我们</b></a>
    </nav>
  </aside>
  <!-- 内容区 -->
