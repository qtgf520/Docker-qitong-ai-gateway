...
<div class="card">
  <div class="logo">
    <div class="icon">⚡</div>
    <h1>綦桐AI网关</h1>
    <p>Docker Server v3.18.22-7 · 后台管理</p>
  </div>
  <div class="tabs">
  ...
  <div class="tip">⚡ Kotlin→Docker 转换版 · v3.18.22-7 Server</div>
</div>
<script>
...
<div id="app">
  ...
  <header class="topbar">
    ...
    <div class="topbar-title">⚡ 綦桐AI网关 <span class="ver">v3.18.22-7</span></div>
